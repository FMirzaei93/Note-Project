...
//This class doesn't have to do anything with the process of collecting data(for example working with AsyncTask classes) and it just
//has the data ready to use.
